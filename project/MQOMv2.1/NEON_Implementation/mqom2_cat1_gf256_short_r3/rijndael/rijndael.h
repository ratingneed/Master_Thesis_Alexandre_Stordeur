...
#if defined(RIJNDAEL_AES_NI) || defined(RIJNDAEL_BITSLICE) || defined(RIJNDAEL_TABLE) || defined(RIJNDAEL_NEON)
#error "RIJNDAEL_CONSTANT_TIME_REF, RIJNDAEL_TABLE, RIJNDAEL_BITSLICE, RIJNDAEL_AES_NI and RIJNDAEL_NEON are exclusive!"
#endif
#endif
#if defined(RIJNDAEL_AES_NI)
#if defined(RIJNDAEL_CONSTANT_TIME_REF) || defined(RIJNDAEL_BITSLICE) || defined(RIJNDAEL_TABLE) || defined(RIJNDAEL_NEON)
#error "RIJNDAEL_CONSTANT_TIME_REF, RIJNDAEL_TABLE, RIJNDAEL_BITSLICE, RIJNDAEL_AES_NI and RIJNDAEL_NEON are exclusive!"
#endif
#endif
#if defined(RIJNDAEL_BITSLICE)
#if defined(RIJNDAEL_AES_NI) || defined(RIJNDAEL_CONSTANT_TIME_REF) || defined(RIJNDAEL_TABLE) || defined(RIJNDAEL_NEON)
#error "RIJNDAEL_CONSTANT_TIME_REF, RIJNDAEL_TABLE, RIJNDAEL_BITSLICE, RIJNDAEL_AES_NI and RIJNDAEL_NEON are exclusive!"
#endif
#endif
#if defined(RIJNDAEL_TABLE)
#if defined(RIJNDAEL_AES_NI) || defined(RIJNDAEL_BITSLICE) || defined(RIJNDAEL_CONSTANT_TIME_REF) || defined(RIJNDAEL_NEON)
#error "RIJNDAEL_CONSTANT_TIME_REF, RIJNDAEL_TABLE, RIJNDAEL_BITSLICE, RIJNDAEL_AES_NI and RIJNDAEL_NEON are exclusive!"
#endif
#endif
...
/* === Constant time AES NEON case (supposes AES NEON ARM-A support) */
#if defined(RIJNDAEL_NEON)
#include "rijndael_neon.h"
#define rijndael_ctx rijndael_aes_neon_ctx
#define aes128_setkey_enc aes128_aes_neon_setkey_enc
#define aes256_setkey_enc aes256_aes_neon_setkey_enc
#define rijndael256_setkey_enc rijndael256_aes_neon_setkey_enc
#define aes128_enc aes128_aes_neon_enc
#define aes256_enc aes256_aes_neon_enc
#define rijndael256_enc rijndael256_aes_neon_enc
#define aes128_enc_x2 aes128_aes_neon_enc_x2
#define aes128_enc_x4 aes128_aes_neon_enc_x4
#define aes128_enc_x8 aes128_aes_neon_enc_x8
#define aes256_enc_x2 aes256_aes_neon_enc_x2
#define aes256_enc_x4 aes256_aes_neon_enc_x4
#define aes256_enc_x8 aes256_aes_neon_enc_x8
#define rijndael256_enc_x2 rijndael256_aes_neon_enc_x2
#define rijndael256_enc_x4 rijndael256_aes_neon_enc_x4
#define rijndael256_enc_x8 rijndael256_aes_neon_enc_x8
static const char rijndael_conf[] = "Rijndael AES NEON (constant time, ARM-A dedicated)";
#endif
