...
#if !defined(RIJNDAEL_CONSTANT_TIME_REF) && !defined(RIJNDAEL_TABLE) && !defined(RIJNDAEL_AES_NI) && !defined(RIJNDAEL_BITSLICE) && !defined(RIJNDAEL_NEON)
/* When AES-NI is present, select the optimized implementation */
#ifdef __AES__
#define RIJNDAEL_AES_NI
/* When AES NEON is present, select the optimized implementation */
#elif defined(__ARM_NEON)
#define RIJNDAEL_NEON
#else
