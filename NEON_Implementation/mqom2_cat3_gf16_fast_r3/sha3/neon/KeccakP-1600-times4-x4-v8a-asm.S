// Keccak-p[1600]x4 hybrid scalar+NEON permutation for AArch64 (no SHA3 needed),
// processing four parallel states. This is the verified scalar/vector hybrid from
// mlkem-native (keccak_f1600_x4_v8a_scalar_hybrid_aarch64_asm.S), derived from:
//
...
// (uint64_t[100] = state0[25]..state3[25]); round constants in standard order.
//
...
//
// void KeccakP1600times4_v8a_permute24(uint64_t state[100], const uint64_t rc[24])
...
.text
.balign 4
.global XKCP_SYM(KeccakP1600times4_v8a_permute24)
#if defined(__ELF__)
.type XKCP_SYM(KeccakP1600times4_v8a_permute24), %function
#endif
XKCP_SYM(KeccakP1600times4_v8a_permute24):
...
#if defined(__ELF__)
.size XKCP_SYM(KeccakP1600times4_v8a_permute24), .-XKCP_SYM(KeccakP1600times4_v8a_permute24)
