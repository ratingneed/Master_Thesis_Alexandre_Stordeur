...
// 		AESE_AESMC	(m1, k1[12]); \
// 		AESE_AESMC	(m2, k2[12]); \
// 		m = vaeseq_u8 	(m1, k1[13]); \
// 		m = vaeseq_u8 	(m2, k2[13]); \
// 		m = veorq_u8 (m1, k1[14]);\
// 		m = veorq_u8 (m2, k2[14]);\
// 	}while(0)
...
// 		m = vaeseq_u8 	(m1, k1[13]); \
// 		m = vaeseq_u8 	(m2, k2[13]); \
// 		m = vaeseq_u8 	(m3, k3[13]); \
// 		m = vaeseq_u8 	(m4, k4[13]); \
// 		m = veorq_u8 (m1, k1[14]);\
// 		m = veorq_u8 (m2, k2[14]);\
// 		m = veorq_u8 (m3, k3[14]);\
// 		m = veorq_u8 (m4, k4[14]);\
...
// {
//     // equivalent of _mm_shuffle_epi32(keygened, _MM_SHUFFLE(3,3,3,3))
//     keygened = vdupq_laneq_u32(vreinterpretq_u32_u8(keygened), 3);
//     keygened = vreinterpretq_u8_u32(keygened);

//     // équivalent de _mm_slli_si128(key, 4)
//     // shift left 4 bytes and fill the right with zeros then xor
