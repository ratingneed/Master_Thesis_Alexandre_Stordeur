...
def plot_inline_alone(link, name, type, title2, legend):
    ...
    plt.yticks(fontsize=18, ha='left', x=-0.70)
    ...
    # plt.show()
    plt.savefig(f"./graphs/images/inline/MQOMv2.1/plot_alone/{link.replace('/', '_')}.pdf", bbox_inches='tight')

def plot_inline_alone_filter(link, name, type, title2, legend):
    print(len(legend))
    ...
    plt.title("Histogram of " + name.upper() + " " + title + "\n" + title2, fontsize=30, pad=20)
    plt.xlabel("Time [cycles]", fontsize=22)
    plt.ylabel("Versions", fontsize=22)
    ...
    plt.yticks(fontsize=22, ha='left', x=-0.32)
...
def plot_inline(link1, link2, name, type, title2, legend):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(f"./graphs/images/inline/MQOMv2.1/plot/{link1.replace('/', '_')}.pdf")
    return
...
def plot_heatmap(link1, link2, name, type, title2, legend, fit):
    ...
    # Create the heatmap
    plt.figure(figsize=(len(df1.columns)*2, len(df1)*1.8))
    ...
    # Set axis labels
    plt.xticks(range(len(delta.columns)), delta.columns, rotation=45, ha='left', fontsize=10)
    plt.yticks(range(len(delta.index)), legend, fontsize=10)

    # Add text annotations with values
    for i in range(len(delta.index)):
        for j in range(len(delta.columns)):
            plt.text(j, i, f'{delta.iloc[i, j]:.1f}', ha='center', va='center', color='black', fontsize=8)

    plt.title(f"Heatmap of {name.upper()} {title}\n{title2}", fontsize=25, pad=20)
    plt.xlabel("Signature schemes", fontsize=10)
    plt.ylabel("Rows", fontsize=10)

    plt.tight_layout(pad=2.0)
    # plt.show()
    plt.savefig(f"./graphs/images/inline/MQOMv2.1/heatmap/{link1.replace('/', '_')}_heatmap2.pdf",
    bbox_inches='tight')
    return

def plot_heatmap_filtered(link1, link2, name, type, title2, legend, fit):
    if type == "gen":
        title = "key generation"
    elif type == "sign":
        title = "signature"
    ...
    plt.title(f"Heatmap of {name.upper()} {title}\n{title2}", fontsize=30, pad=20)
    plt.xlabel("Signature schemes", fontsize=17)
    plt.ylabel("Rows", fontsize=17)

    plt.tight_layout(pad=2.0)
    # plt.show()
    plt.savefig(f"./graphs/images/inline/MQOMv2.1/heatmap/{link1.replace('/', '_')}_heatmap.pdf",
    bbox_inches='tight')
    return

# keygen
legend = ["declarations", "allocation", "sanity checks", "row 1-2", "row 3", "row 4 (loop)", "row 7", "row 8", "cleanup"]
# plot_inline_alone("data/benchmark/avx2_inline/gen/mqom2.1.csv",
#             "MQOMv2.1", "gen", "internal analysis AVX2", legend)

# plot_inline_alone("data/benchmark/neon_inline/gen/mqom2.1.csv",
#             "MQOMv2.1", "gen", "internal analysis NEON", legend)

# plot_inline_alone_filter("data/benchmark/avx2_inline/gen/mqom2.1.csv",
#             "MQOMv2.1", "gen", "internal analysis AVX2 CAT. I", legend)

# plot_inline_alone_filter("data/benchmark/neon_inline/gen/mqom2.1.csv",
#             "MQOMv2.1", "gen", "internal analysis NEON CAT. I", legend)

# plot_heatmap("data/benchmark/avx2_inline/gen/mqom2.1.csv",
#             "data/benchmark/neon_inline/gen/mqom2.1.csv",
#             "MQOMv2.1", "gen", "internal analysis", legend, 0.05)

plot_heatmap_filtered("data/benchmark/avx2_inline/gen/mqom2.1.csv",
            "data/benchmark/neon_inline/gen/mqom2.1.csv",
            "MQOMv2.1", "gen", "internal analysis CAT. I", legend, 0.05)
...
# plot_inline_alone("data/benchmark/avx2_inline/sign/mqom2.1.csv",
#             "MQOMv2.1", "sign", "internal analysis AVX2", legend)

# plot_inline_alone("data/benchmark/neon_inline/sign/mqom2.1.csv",
#             "MQOMv2.1", "sign", "internal analysis NEON", legend)

# plot_inline_alone_filter("data/benchmark/avx2_inline/sign/mqom2.1.csv",
#             "MQOMv2.1", "sign", "internal analysis AVX2 CAT. I", legend)

# plot_inline_alone_filter("data/benchmark/neon_inline/sign/mqom2.1.csv",
#             "MQOMv2.1", "sign", "internal analysis NEON CAT. I", legend)

# plot_heatmap("data/benchmark/avx2_inline/sign/mqom2.1.csv",
#             "data/benchmark/neon_inline/sign/mqom2.1.csv",
#             "MQOMv2.1", "sign", "internal analysis", legend, 0.05)

plot_heatmap_filtered("data/benchmark/avx2_inline/sign/mqom2.1.csv",
            "data/benchmark/neon_inline/sign/mqom2.1.csv",
            "MQOMv2.1", "sign", "internal analysis CAT. I", legend, 0.05)

# verif
legend = ["declaration", "row 1", "row 2", "row 3", "row 4", "row 5", "row 6", "row 7", "row 8 and 9", "row 10", "row 11", "row 12"]
# plot_inline_alone("data/benchmark/avx2_inline/verif/mqom2.1.csv",
#             "MQOMv2.1", "verif", "internal analysis AVX2", legend)

# plot_inline_alone("data/benchmark/neon_inline/verif/mqom2.1.csv",
#             "MQOMv2.1", "verif", "internal analysis NEON", legend)

# plot_inline_alone_filter("data/benchmark/avx2_inline/verif/mqom2.1.csv",
#             "MQOMv2.1", "verif", "internal analysis AVX2 CAT. I", legend)

# plot_inline_alone_filter("data/benchmark/neon_inline/verif/mqom2.1.csv",
#             "MQOMv2.1", "verif", "internal analysis NEON CAT. I", legend)

# plot_heatmap("data/benchmark/avx2_inline/verif/mqom2.1.csv", 
#             "data/benchmark/neon_inline/verif/mqom2.1.csv",
#             "MQOMv2.1", "verif", "internal analysis", legend, 0.05)

plot_heatmap_filtered("data/benchmark/avx2_inline/verif/mqom2.1.csv",
            "data/benchmark/neon_inline/verif/mqom2.1.csv",
            "MQOMv2.1", "verif", "internal analysis CAT. I", legend, 0.05)