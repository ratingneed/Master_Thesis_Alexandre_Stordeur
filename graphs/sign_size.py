...
categories = ["CROSS-R-SDP fast",  "CROSS-R-SDP balanced", "CROSS-R-SDP small", "CROSS-R-SDP(G) fast", "CROSS-R-SDP(G) balanced", "CROSS-R-SDP(G) small", 
              ...
              "MQOM2.1-gf2-short-3r","MQOM2.1-gf16-short-3r", "MQOM2.1-gf256-short-3r", 
              "MQOM2.1-gf2-fast-3r","MQOM2.1-gf16-fast-3r", "MQOM2.1-gf256-fast-3r", 
              "MQOM2.1-gf2-short-5r","MQOM2.1-gf16-short-5r", "MQOM2.1-gf256-short-5r", 
              "MQOM2.1-gf2-fast-5r","MQOM2.1-gf16-fast-5r", "MQOM2.1-gf256-fast-5r"]
...
# Paramètres
x = np.array([0, 0.6, 1.2, 1.8, 2.4, 3, 3.8, 4.2, 4.6, 5, 5.8, 6.4, 7, 7.6, 8.2, 8.8, 9.4, 10, 10.6, 11.2, 11.8, 12.4])  
...
# Titres
plt.title("Histogram of Signature size in Bytes (log scale)", fontsize=22)
...
#plt.show()
plt.savefig("./graphs/images/sign.pdf")
